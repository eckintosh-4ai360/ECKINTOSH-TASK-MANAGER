    ...
    <>
      ...
      {preview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
          <div className="bg-card rounded-2xl p-5 max-w-md w-full mx-4 border border-border/60 shadow-2xl">
            ...
            {/* Preview */}
            <div className="rounded-xl overflow-hidden mb-4 bg-muted flex items-center justify-center min-h-[120px]">
              {preview.type === "image" && (
      ...
      <div className="relative">
        ...
        {open && (
          <>
            ...
            <div className="absolute bottom-12 left-0 z-20 bg-card border border-border/60 rounded-2xl p-2 shadow-2xl flex gap-1">
              {[
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 px-3 py-3 rounded-xl hover:bg-muted transition-colors group"
                >
                  <div className={`w-10 h-10 rounded-full bg-muted flex items-center justify-center ${color} group-hover:scale-110 transition-transform`}>
